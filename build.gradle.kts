...
group = "com.zmkn.kotlin.serializers"
    ...
    configure<PublishingExtension> {
        publications {
            create<MavenPublication>("mavenJava") {
                ...
                pom {
                    name.set("Bson Kotlin Serializers Module")
                    description.set("Bson serializers module for Kotlin")
                    url.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module")
                    inceptionYear.set("2025")
                    licenses {
                        license {
                            name.set("MIT License")
                            url.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module/blob/master/LICENSE")
                        }
                    }
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/zmkn/kotlin-time-kotlin-serializers-module.git")
                        developerConnection.set("scm:git:git@github.com:zmkn/kotlin-time-kotlin-serializers-module.git")
                        url.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module")
                    }
                }
            }
...
if (localProperties.getProperty("jreleaser.enable") == "true") {
    ...
    configure<org.jreleaser.gradle.plugin.JReleaserExtension> {
        project {
            ...
            // A list of tags.
            tags.addAll(listOf("bson", "kotlin"))
            ...
            links {
                homepage.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module")
                documentation.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module/wiki")
                license.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module/blob/master/LICENSE")
                bugTracker.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module/issues")
                donation.set("https://github.com/zmkn/kotlin-time-kotlin-serializers-module")
            }
        }
        signing {
            ...
            maven {
                github {
                    create("github") {
                        ...
                        url.set("https://maven.pkg.github.com/zmkn/kotlin-time-kotlin-serializers-module")
